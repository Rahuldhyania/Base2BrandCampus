...
export const metadata = {
    ...
    keywords: [
        'Truck Dispatch Course in Mohali',
        'B2B Campus Truck Dispatch Training',
        'Truck Dispatch Course Punjab',
        'US Truck Dispatcher Course India',
        'Logistics Training Institute Mohali'
    ]
}
const page = () => {
