...
const listData2 = [
  {
    ...
    listdata: [
      ...
      "Exposure to IT companies and startup",
...
const listData3 = [
  {
    title:
      "An ideal training program should offer:",
    listdata: [
...
const listData4 = [
  {
    title:
      "Popular training domains include:",
    listdata: [
        ...
        <div className="flex gap-2">
          <div className="lg:w-[70%]">
            <Page2Banner
              ...
              discription2={"If you are searching for the best six weeks industrial training in Chandigarh, this guide will help you understand its importance, benefits, and why B2B Campus in Chandigarh and Mohali stands out as a trusted destination for practical, career-oriented training."}
            />
            <Page2TitleDisList
              title={"1. Why Six Weeks Industrial Training Is Important for Students"}
              discription1={"Six weeks industrial training is not just a mandatory requirement set by universities; it is an opportunity to gain real-world exposure before entering the job market. During this short yet intensive period, students transition from theory-based learning to practical implementation."}
              listData={listData1}
              discription2={"For many students, six weeks of focused training becomes the turning point that defines their career direction."}
            />
            <Page2TitleDisList
              title={"2. Why Chandigarh Is a Hub for Industrial Training?"}
              discription1={"Chandigarh has emerged as one of North India’s leading education and IT training hubs. Its proximity to Mohali’s IT parks, startup ecosystem, and corporate offices makes it an ideal location for students seeking quality industrial exposure."}
              listData={listData2}
              discription2={"Among the many institutes offering training, choosing the right one is what makes all the difference."}
            />
            <Page2TitleDisList
              title={"3. What Makes a Six Weeks Industrial Training Program “Best”?"}
              discription1={"Not all industrial training programs deliver the same value. The best six weeks industrial training should focus on skill development rather than just certificates."}
              listData={listData3}
              discription2={"This is where B2B Campus sets itself apart."}
            />
            <Page2TitleDisList
              title={"4. B2B Campus: A Trusted Name for Six Weeks Industrial Training in Chandigarh"}
              discription1={"B2B Campus, with centers in Chandigarh and Mohali, is recognized as one of the best institutes providing six weeks industrial training for students. The institute is known for its practical teaching approach, student-centric training modules, and strong industry alignment."}
              discription2={"B2B Campus focuses on preparing students not just to complete their training, but to become industry-ready professionals."}
            />
            <Page2TitleDisList
              title={"5. Courses Offered at B2B Campus for Six Weeks Industrial Training"}
              discription1={"B2B Campus offers a wide range of in-demand courses designed specifically for short-term industrial training. Students can choose a specialization based on their academic background and career goals."}
              listData={listData4}
              discription2={"Each course is structured to deliver maximum learning within six weeks, combining theory, practice, and project work."}
            />
            <Page2TitleDisList
              title={"6. Practical Learning with Real Project Exposure"}
              discription1={"One of the biggest advantages of choosing B2B Campus for six weeks industrial training is the emphasis on practical learning. Students don’t just watch demos — they actively work on assignments and projects."}
              listData={listData5}
              discription2={"This hands-on approach ensures students gain skills they can confidently showcase during interviews."}
            />
            <Page2TitleDisList
              title={"7. Experienced Trainers and Personalized Mentorship"}
              discription1={"At B2B Campus, training is delivered by experienced industry professionals who understand current market requirements. Trainers focus on explaining concepts in a simple, practical manner, making learning easier even for beginners."}
              listData={listData6}
              discription2={"This mentorship-driven approach makes B2B Campus an ideal choice for students who want more than surface-level training."}
            />
            <Page2TitleDisList
              title={"8. Who Can Join the Six Weeks Industrial Training at B2B Campus?"}
              listData={listData8}
