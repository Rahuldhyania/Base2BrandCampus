...
export const metadata = {
    title : 'Top IT Certification Courses in Chandigarh | B2B Campus',
    description : 'B2B Campus offers top IT certification courses in Chandigarh with hands-on training, expert mentors, and career-focused learning. Apply today! Start your career.'
}
const page = () => {
    return (
