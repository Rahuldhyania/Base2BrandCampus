...
import Whatyoulearn from '../Components/Page-Components/Whatyoulearn';
import IndustrialHighlight from '../Components/Page-Components/IndustrialHighlight';
import TraningStep from '../Components/Page-Components/TraningStep';
import CerticateIndus from '../Components/Page-Components/CerticateIndus';
...
const Industrialwrap = () => {
    ...
    return (
        <div>
            ...
            <IndustrialHighlight />
            <TraningStep />
            <CerticateIndus scrollclick={scrollToEnrolment} />
            <PlacementPartner />
            <Youtubevideo />
