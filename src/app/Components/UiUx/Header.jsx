...
const coursesData = {
  AllCourses: [
    ...
    { name: "Safety & Compliance (Truck Dispatching)", path: "/truck-dispatch-safety-compliance-course", trandingCource: true },
          ...
          <ul className="flex flex-col gap-4 text-[18px] px-4 py-4">
            ...
            <div className="pt-4">
              <div className="flex items-start gap-3">
                ...
                <p className="text-base md:text-2xl leading-snug flex items-center gap-2">
                ...
                {coursesData[activeCategory]?.map((course, index) => (
                  ...
                  >
                    ...
                    {course.trandingCource
                      ? <div>
                        <p class="text-[8px] md:text-[9px] w-fit absolute right-2 top-1 px-[8px] py-[2px] text-white rounded-[23px] flex items-center gap-1 animate-[bgBlink_1s_infinite]">
                          <span class="w-[6px] h-[6px] rounded-full animate-[dotBlink_1s_infinite]" />
                          {course.trandingSecondary ?  `Most Trending — ${nextBatchDateSecondary}` : `NEXT BATCH  — ${nextBatchDate}`}
                        </p>
                      </div>
                      : null}
                  </Link>
