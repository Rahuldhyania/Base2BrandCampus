...
const InternetOfThings = () => {
  ...
  const featuresMain = [
    ...
    },
    {
      ...
      subtitle: "Design, test & deploy IoT solutions from anywhere."
    },
    {
    ...
    },
    {
      ...
      subtitle: "We teach from basics – sensors, coding, circuits & cloud."
    }
  ];
  const items = [
    {
  ...
  const program_data = [
    ...
    {
      text: "Basics of IoT & Embedded Systems",
    ...
    {
      text: "Real IoT Projects & Portfolio Building",
      icon: "/images/greencheck.webp"
    }
  ];
  const conjoin_data = [
    ...
    {
      text: "Anyone wanting future-ready tech skills",
      icon: "/images/greencheck.webp"
    }
  ];
  const featuresNumbered = [
    ...
    },
    {
      ...
      description: "Personal guidance for coding, circuits & debugging."
    },
    {
      id: 4,
      number: 4,
      title: "Industry-Level Problem Solving",
      description: "Learn how IoT works in real companies and smart systems."
    },
    {
      id: 5,
      number: 5,
      title: "Portfolio & GitHub Support",
      description: "Graduate with deployable IoT projects and cloud dashboards."
    },
    {
      id: 6,
      number: 6,
      title: "Guaranteed Internship",
      description: "Get hands-on experience working on real IoT assignments."
    }
  ];
  ...
  return (
    <div>
      <CoursesBanner
        ...
        description={
          "Master Sensors • Microcontrollers • Automation • Cloud Integration • Live Projects"
        }
      ...
      <CourseProgram
        ...
        title={
          '<span class="text-primary">3 Months Intensive </span> <br/> Internet of Things (IoT) Program'
        }
      />
      <AboutCourse
      ...
      <BecomeStudent
        title={
          'IoT Courses & Certifications To  ​<sapn class="text-primary"> Learn Smart Technologies </span>'
        }
