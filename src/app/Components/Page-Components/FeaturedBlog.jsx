            ...
            <div className="cus_container">
                ...
                <div className="main_grid_custom_blog pb-[40px] sm:pb-[50px] md:pb-[60px] lg:pb-[75px]">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        {/* LEFT CARD */}
                        {FeaturedBlog[0] && (
                            <a href="javascript:void(0)" className="bg-white group cursor-pointer rounded-2xl overflow-hidden shadow-[0_7px_29px_rgba(100,100,111,0.2)] transition-all duration-300 hover:-translate-y-2">
                                <img src={FeaturedBlog[0].image} alt={FeaturedBlog[0].title} className="w-full h-[260px] md:h-[320px] object-cover" />
                                <div className="p-6">
                                    <span className="inline-block transition-all duration-300 ease-in-out text-[#6346FA] group-hover:text-[#fff] bg-[#E4E0FC] group-hover:bg-[#000] text-sm px-3 py-1 rounded-lg mb-3">{FeaturedBlog[0].courseName}</span>
                        ...
                        <div className="flex flex-col gap-6">
                            {FeaturedBlog.slice(1).map((blog, index) => (
                                <a href="javascript:void(0)" key={index} className="bg-white group cursor-pointer rounded-2xl overflow-hidden shadow-[0_7px_29px_rgba(100,100,111,0.2)] transition-all duration-300 hover:-translate-y-2">
