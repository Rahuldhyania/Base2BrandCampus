    ...
    <div>
      <section className="cus_container py-12">
        ...
        <div className=" mx-auto md:p-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {featuresNumbered.map(({ id, number, title, description }) =>
            ...
            >
              ...
              <h3 className="text-lg 2xl:text-2xl  mb-2 relative z-10">
                {title}
              </h3>
              <p className="text-sm 2xl:text-[17px] md:w-[85%] leading-relaxed relative z-10">
                {description}
              </p>
            </div>
          )}
        ...
        <div className="flex items-center justify-center flex-col lg:flex-row gap-4 lg:gap-10 pt-4">
            ...
            <div>
              ...
              <div>
                <p className="text-base md:text-xl">
                  Rated <span className="text-primary">4.9/5</span> by{" "}
                  <span className="text-primary">1254+ Students</span>
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <Buttons btnname={"Start Learning Now"} text_color={"text-white"} />
          </div>
        </div>
      </section>
    </div>
