...
import SingleknowledgeCenterContent from '../Components/Page-Components/SingleknowledgeCenterContent'
...
const page = () => {
    ...
    return (
        <div>
            <BlogDetailsHead backbtn="Back to Articles" share_btn="Share" />
            <SingleknowledgeCenterContent />
